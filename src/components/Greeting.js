...
function Greeting() {
  ...
  const[greeting, setFormState] = useState("Welcome the following students to class!");
  ...
  // TODO: Convert `group` to a state variable using the useState hook. Set to an initial value to an array including three students in your class. (ex. ["John", "Grace", "Jared"])
   const [group, setGroup]= useState(['Student 1 James', 'Stud 2 student', 'Study the man']);
